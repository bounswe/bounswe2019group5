...
public class ImageEssayDetailTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final String dummy_response = "{\"id\":32,\"type\":\"writing\",\"language\":\"english\",\"writing\":\"http:\\/\\/35.158.176.194\\/media\\/essays\\/essay_ZMZhq0p.png\",\"reviewer\":\"kbozdogan\",\"author\":\"notme\",\"status\":\"pending\"}";
        Essay essay;
